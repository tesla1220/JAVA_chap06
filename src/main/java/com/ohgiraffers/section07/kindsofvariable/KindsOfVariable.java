...
//        System.out.println(localnum);     // 지역변수 못불러옴!! 왜냐? 지역변수는 해당 지역(블럭 내부) 에서만 사용 가능하기 때문
//        System.out.println(num);           // 지역변수 못불러옴!! 왜냐? 지역변수는 해당 지역(블럭 내부) 에서만 사용 가능하기 때문

        System.out.println(globalNum);      // 전역 변수는 다른 메소드에서도 상관없이 사용 가능!
        System.out.println(staticNum);      // 전역 변수는 다른 메소드에서도 상관없이 사용 가능!
