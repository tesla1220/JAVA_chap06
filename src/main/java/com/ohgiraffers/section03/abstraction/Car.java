...
public class Car {
    ...
    private boolean isOn;   // boolean의 기본값은 false. 그래서 초기에는 시동이 꺼진 false 상태임
    private int speed;
    ...
    public void startUp() {
        ...
        if (isOn) {
            ...
            this.isOn = true;
            System.out.println("시동을 걸었습니다. 이제 출발할 준비가 됐습니다. ");
        }


    }

    /* 시동이 걸린 상태인 경우, 호출 시 10km 씩 속도를 증가시킨다. */
    public void go() {
    ...
    public void stop() {
        ...
        if (isOn) {
            ...
            System.out.println("차의 시동이 걸려있지 않습니다. 먼저 시동을 걸어주세요.");
        }
    }
